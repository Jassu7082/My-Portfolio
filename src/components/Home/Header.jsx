...
const Header = () => {
    ...
    return (
        <div id="Home" className="flex flex-col gap-2 m-2  container justify-center md:flex-1 md:max-w-[850px] pt-16 sm:items-center w-full making">
            ...
            <div className='flex-inline w-[50%] translate-x-[150%] dont_need' >
                <Wallpaper />
            </div>
        </div>
    );
